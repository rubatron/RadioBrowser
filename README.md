...
```bash
curl -sL https://raw.githubusercontent.com/rubatron/RadioBrowser/develop/radio-browser/install.sh | sudo bash
```

**wget:**

```bash
wget -qO- https://raw.githubusercontent.com/rubatron/RadioBrowser/develop/radio-browser/install.sh | sudo bash
```
